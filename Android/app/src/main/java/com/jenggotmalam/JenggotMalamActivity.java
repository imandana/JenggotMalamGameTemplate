...
public class JenggotMalamActivity extends android.app.Activity implements SurfaceHolder.Callback
{
	...
	JenggotMalamAudio mAudio = null;
	JenggotMalamAccelerometer mAccelerometer = null;
	...
	{
		android.util.Log.v("JENGGOTMALAM", "Started onCreate function");
		...
		mView.setOnKeyListener(new android.view.View.OnKeyListener() { @Override public boolean onKey(android.view.View v, int keyCode, KeyEvent event)
		{
			...
			android.util.Log.v("JENGGOTMALAM", "keyCode: " + keyCode + " - action: " + action + " - unicode: " + event.getUnicodeChar());
	...
	{
		if (mAudio == null) mAudio = new JenggotMalamAudio(this);
		return mAudio;
	}
	...
	{
		if (mAccelerometer == null) mAccelerometer = new JenggotMalamAccelerometer(this);
	...
	private class JenggotMalamAccelerometer implements android.hardware.SensorEventListener
	{
		private SensorManager mSensorManager = null;
		private JenggotMalamActivity mContext;
		private boolean mUseGyroscope = false;
		private boolean mUseAccelerometer = false;

		public JenggotMalamAccelerometer(JenggotMalamActivity context)
		{
			mContext = context;
		}
	...
	private class JenggotMalamAudio
	{
		private JenggotMalamActivity mContext;
		...
		public JenggotMalamAudio(JenggotMalamActivity context) { mContext = context; }
		...
		{
			android.util.Log.d("JENGGOTMALAM_AUDIO", "open apk file Offset: " + offset + " - size: " + size);
			try
			{
				Stream s = new Stream();
		...
		{
			android.util.Log.d("JENGGOTMALAM_AUDIO", "Control streamed audio - Mode: " + mode);
	...
	//private class JenggotMalamSurfaceView extends android.view.SurfaceView
	//{
	//	public JenggotMalamSurfaceView(Context context) { super(context); }
	...
	//		return new JenggotMalamInputConnection(this, false);
	//	}
	//}
	//private class JenggotMalamInputConnection extends android.view.inputmethod.BaseInputConnection
	//{
	//	public JenggotMalamInputConnection(android.view.View targetView, boolean fullEditor) { super(targetView, fullEditor); }
